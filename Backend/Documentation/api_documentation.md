...
## Overview
The FinePrint backend parses financial documents (PDF/images) using Gemini 2.0 Flash to identify predatory clauses ("Scary Stuff"). The frontend should provide a UI with a PDF viewer on the left, and a "Risk Cards" panel on the right.
